...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth: Interceptor? = when (authName) { 
                "ApiKey" -> ApiKeyAuth("header", "x-api-key")
                
                "oAuth2" -> OAuth(OAuthFlow.accessCode, "https://api.alogram.ai/oauth2/authorize", "https://api.alogram.ai/oauth2/token", "payrisk.read, payrisk.write")
    ...
    companion object {
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://api-dev.alogram.ai/v1")
        }
    }
}
